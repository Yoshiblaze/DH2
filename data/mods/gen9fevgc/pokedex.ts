...
// NFEs
	...
	chonkee: {
		...
		abilities: {0: "Smell Ya Later", 1: "Stress Eating", H: "Afatpability"},
		weightkg: 8.4,
		evos: ["Oinkeon-F"],
	},
	shellee: {
		...
		abilities: {0: "Slug Speed", 1: "Nudibranch", H: "Sand Scatter"},
		weightkg: 6.4,
		evos: ["Sylveodon"],
	},
	eebas: {
		...
		abilities: {0: "Speedster", 1: "Goldfish Brain", H: "Overprepared"},
		weightkg: 7,
		evos: ["Umbrelotic"],
	},
	eedudee: {
		...
		abilities: {0: "Rockability", 1: "Boulder Dash", H: "Pocket Sand"},
		weightkg: 13.3,
		evos: ["Goleaf"],
	},
	cranidlett: {
